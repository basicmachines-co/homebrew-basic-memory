class BasicMemory < Formula
  ...
  url "https://github.com/basicmachines-co/basic-memory/archive/refs/tags/v0.23.1.tar.gz"
  sha256 "db102ea0376bb68a80369abffa5ab6afa6884759810a33441c06b2cc38f6e39d"
