class BasicMemory < Formula
  ...
  url "https://github.com/basicmachines-co/basic-memory/archive/refs/tags/v0.20.3.tar.gz"
  sha256 "324e2d6e3e0e22aa338e379999116a44094050a56764c01faac7ceb10e1cf6b6"
